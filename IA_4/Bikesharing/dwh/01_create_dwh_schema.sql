-- ============================================================================
-- DWH Schema - Versione psql (CLI)
-- ============================================================================

-- ATTENZIONE: richiede privilegi per creare/droppare database
DROP DATABASE IF EXISTS bikesharing_dwh;
CREATE DATABASE bikesharing_dwh;
