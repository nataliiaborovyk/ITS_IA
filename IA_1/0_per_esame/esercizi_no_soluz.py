...
### Soluzione:
print("***ESERCIZIO 3***")
dfr = df[df['Genre']=='rock']
df2 = df[df['Genre'].str.contains('rock', case=False)]
print("*****************"+"\n")
...
### Soluzione:
print("***ESERCIZIO 6***")
df['Durata'] = pd.to_timedelta(df['Length'])
max_ind = df['Durata'].idxmax()
...
### Soluzione:  
print("***ESERCIZIO 12***")
df[df['dif']] = df['Claimed Sales'] - df['Music Recording Sales']
df
print("******************"+"\n")
